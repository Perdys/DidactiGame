...
import static com.mygdx.DidacticGame.Auxiliares.Jugador.*;
import static com.mygdx.DidacticGame.Pantallas.Menus.Menu_Ranking.*;
...
public class Base_Datos {
    ...
    public Base_Datos () {
        ...
        try {
            ...
            rosco_bd = DriverManager.getConnection(direccion(bdUrl, "rosco"));
            ...
            qqsm_bd = DriverManager.getConnection(direccion(bdUrl, "qqsm"));
    ...
    public String direccion (String dbUrl, String dbName) {
        File dir;
        dir = new File(Gdx.files.getLocalStoragePath());
        dbName = dbName + ".db";
    ...
    public void leer_jugadores(ArrayList<Jugador> coleccion) {
        try {
            ...
            while (rs.next())
                coleccion.add(new Jugador(rs.getString(1), rs.getInt(2), rs.getString(3)));
    ...
    public void actualizar_respuesta0(String pregunta, String respuesta0) {
        try {
            qqsm_sentencia.executeUpdate("update qqsm set respuesta0 = '" + respuesta0.trim() + "' where pregunta = '"+ pregunta + "'");
    ...
    public void actualizar_respuesta1(String pregunta, String respuesta1) {
        try {
            qqsm_sentencia.executeUpdate("update qqsm set respuesta1 = '" + respuesta1.trim() + "' where pregunta = '"+ pregunta + "'");
    ...
    public void actualizar_respuesta2(String pregunta, String respuesta2) {
        try {
            qqsm_sentencia.executeUpdate("update qqsm set respuesta2 = '" + respuesta2.trim() + "' where pregunta = '"+ pregunta + "'");
    ...
    public void actualizar_respuesta3(String pregunta, String respuesta3) {
        try {
            qqsm_sentencia.executeUpdate("update qqsm set respuesta3 = '" + respuesta3.trim() + "' where pregunta = '"+ pregunta + "'");
    ...
    public void anadir_jugador(String jugador, int edad, String color) {
        try {
    ...
    public void actualizar_edad(String jugador, int edad) {
        try {
    ...
    public void anadir_fichero_preguntas(File direccion) {
        ...
        for (int i = 0; i < lineas.length; ++i) {
            campos = lineas[i].split("/");
            pregunta.pregunta = campos[0];
            pregunta.correcta = campos[1];
            pregunta.respuestas[0] = campos[2];
            pregunta.respuestas[1] = campos[3];
            pregunta.respuestas[2] = campos[4];
            pregunta.respuestas[3] = campos[5];
