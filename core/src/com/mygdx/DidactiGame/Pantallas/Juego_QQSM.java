...
public class Juego_QQSM extends Pantalla{
                    ...
                    default:
                        if (jugadores.jugador_actual().jugando) {
                            if (pregunta_actual.correcta.compareTo(pregunta_actual.respuestas[eleccion]) == 0) {
                                //acierto
                                jugadores.jugador_actual().n_aciertos_qqsm += 1;
                                aciertos_etiqueta.setText(Integer.toString(jugadores.jugador_actual().n_aciertos_qqsm));
                                siguiente_pregunta();
                            } else {
                                //fallo
                                jugadores.jugador_actual().n_fallos_qqsm += 1;
                                jugadores.jugador_actual().jugando = false;
                                siguiente_jugador();
                            }
                        } break;
    ...
    public void textos_cargar() {
        ...
        tiempo_etiqueta = new Label("GO", texto_estilo(0.165));
        tiempo_etiqueta.setWidth(proporcion_x(0.3));
        tiempo_etiqueta.setPosition(proporcion_x(0.525), proporcion_y(0.74));
        ...
        pregunta_scroll.setBounds(proporcion_x(0.1), proporcion_y(0.5), proporcion_x(0.8), proporcion_y(0.25));
